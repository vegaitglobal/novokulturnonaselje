...
namespace NKN.Core.Controllers.Surface
{
    public abstract class BaseSurfaceController : SurfaceController
    {
        ...
        {
            return Umbraco.CreateSiteContext();
        }
        ...
        protected override void OnException(ExceptionContext filterContext)
        {
            ...
            Logger.Error(GetType(),
                $"An unhandled exception occurred on surface controller action '{filterContext.RouteData.Values["action"]}'!",
