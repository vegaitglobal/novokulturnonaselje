...
namespace NKN.Models.Extensions
{
    public static class PublishedElementPropertyExtensions
    {
        ...
        public static T GetPropertyValue<T>(this IPublishedElement source,
        ...
        public static T GetPropertyWithDefaultValue<T>(this IPublishedElement source, T defaultValue,
            [CallerMemberName] string propertyName = null)
        {
            return source.HasValue(propertyName) ? source.Value<T>(propertyName) : defaultValue;
        }
        ...
        public static T GetPropertyWithDefaultValue<T>(this IPublishedElement source, Func<T> defaultValueFactory,
            [CallerMemberName] string propertyName = null)
        {
